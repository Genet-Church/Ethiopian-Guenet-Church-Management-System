...
export default function SuperAdminDashboard() {
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="space-y-8 max-w-7xl mx-auto pb-12">
      {/* ═══════════ Hero Banner ═══════════ */}
      <motion.div variants={itemVariants} className="relative overflow-hidden rounded-xl sm:rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-[#0c1929] via-[#1e3a5f] to-[#4B9BDC] p-6 sm:p-10 md:p-12 shadow-2xl group">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className={`flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl font-bold transition-all shadow-lg active:scale-95 border ${maintenanceMode
